...
<CardGroup cols={2}>
  ...
  <Card title="Edit an image" icon="paintbrush">
    "Upload portrait.png and replace the background with a warm sunset. Estimate first, then generate after I confirm."
  </Card>

  <Card title="Generate a video" icon="video">
    "Make a short 16:9 video of waves rolling onto a black-sand beach at sunset. Quote the credits, then generate."
  </Card>

  <Card title="Animate an image" icon="film">
    "Turn the image you just generated into a short video with a slow push-in, and give me the video URL and what was charged."
  </Card>
</CardGroup>
